...
const AddCraft = () => {   
    ...
    const handleAddCraft = event =>{
        ...
        const addedCraft = {item_name, subcategory_Name, description, processing_time, price, rating, customization, stockStatus, image, name, email };
    ...
    return (
       ...
       <div className="text-center my-4">
         <h2 className="text-3xl font-bold font-serif mb-2 text-slate-900">Add Craft Item</h2>
        ...
        <div className="form-control bg-base-200"> 
         ...
         <div className="form-control">
          ...
          <div className="mb-10  mt-12">            
            <input type="submit" value="Add Craft" className="btn-secondary w-full p-2 bg-slate-900 border-slate-950"/>
        </div>      
        </div>         
      </div>       
     </div>                     
