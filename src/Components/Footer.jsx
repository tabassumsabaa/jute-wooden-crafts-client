...
const Footer = () => {
    return (
        <div>
             <footer >
            <div className="footer  bg-base-200 text-base-content rounded">
            <div className=" p-10 pl-16">
             <img src={footIcon} alt="" className="max-h-20 rounded-full shadow-xl" /> 
             <h2 className="text-3xl text-slate-800 font-bold my-5">Coffee Emporium</h2>
  ...
  <table className="table">
    ...
    <div className="text-center ">
      <h1 className="text-5xl  text-slate-800 font-thin font-mono mb-5">Connect With Us!</h1>      
    </div>
      ...
      <form className="card-body">
        ...
        <div className="form-control w-2/4 mt-6">
          <button className="btn btn-outline bg-slate-100 hover: text-slate-800 rounded-3xl">Send Massage</button>
            ...
            <div className="text-center">
               <aside>                 
                  <img src={footImg} alt="" className="max-h-12 w-full absolute" />
                  <p className="relative text-slate-100 -mt-6 mb-5  items-center">Copyright © 2024 - All right reserved by Subbha ki Saba</p>
              </aside>
             </div>
          </footer>
